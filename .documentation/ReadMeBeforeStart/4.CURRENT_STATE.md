...
- **Net Energy Tab**:
  ...
  - **Self-Sufficiency Rate** (NEW 2026-01-07):
    - Average self-sufficiency rate metric card showing (Generation / Consumption) × 100%
    - Self-Sufficiency Rate Trend chart with 100% threshold line
    - Color coding: Green (≥100% self-sufficient), Orange (<100% grid dependent)
    - Tooltip shows rate and status for each time point
    - Backend calculates rate for each hour and average across period
  - Explanatory info cards
  - Data source: TL339 (net energy), TL341 (consumption), TL340 (generation)
...
- Electricity Components: 17 (7 shared + 3 consumption + 2 generation + 2 net energy + 3 forecast) - Added SelfSufficiencyRateChart
