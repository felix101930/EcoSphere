...
### 决策 #2: 数据库方案
**日期**: 2025-11-27  
**决策**: Prototype阶段使用Mock数据，不连接真实SQL Server  
**理由**:
- 客户数据表结构还未最终确定
- Prototype重点是展示功能和UI
- 开发速度更快
...
### 决策 #5: 碳足迹数据存储
**日期**: 2025-11-27  
**决策**: 使用独立的CARBON_FOOTPRINT表设计（Mock数据）  
**理由**:
- 符合数据库规范化原则
- 支持两种计算模式
- 易于扩展
...
### 决策 #6: Forecast功能
**日期**: 2025-11-27  
**决策**: Prototype阶段不实现Forecast功能，仅创建Skeleton  
**理由**:
