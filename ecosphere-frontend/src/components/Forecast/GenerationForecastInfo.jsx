                ...
                {model && model.coefficients && (
                    <Box sx={{ mb: 2 }}>
                        ...
                        <Typography variant="caption" color="text.secondary" display="block" sx={{ mt: 1 }}>
                            <strong>Coefficient ({model.coefficients.direct_radiation.toFixed(2)}):</strong> Represents the conversion efficiency -
                        ...
                        <Typography variant="caption" color="text.secondary" display="block" sx={{ mt: 0.5 }}>
                            <strong>Intercept ({model.intercept.toFixed(2)}):</strong> Baseline adjustment factor accounting for system losses and other fixed effects.
                        </Typography>
                        <Typography variant="caption" color="text.secondary" display="block" sx={{ mt: 1 }}>
                            These values are calculated using Simple Linear Regression on {trainingDays} days of historical data.
                            Direct solar radiation is the strongest predictor of solar panel generation (correlation: 0.80).
                        </Typography>
                    </Box>
                )}
